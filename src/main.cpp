...
DimmerLib::LightSensingDimmer dimmer_0(A4, 6, 5, A3, 0);
DimmerLib::LightSensingDimmer dimmer_1(A4, 8, 7, A2, 1);
DimmerLib::LightSensingDimmer dimmer_2(A4, 10, 9, A1, 2);
DimmerLib::LightSensingDimmer dimmer_3(A4, 21, 20, A0, 3);


// Example with an ISR:s for all the dimmers
MAKE_MODE_SWITCH_ISR(dimmer_0_ISR, dimmer_0)
